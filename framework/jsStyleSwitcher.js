...
$jqInitColors(document).ready(function () {
    ...
    $jqInitColors('#divH_Cat .color-picker > .select-color-image').css(background_rgb);

    $jqInitColors('.h-cat-1 .modern-items-list .fold-item .description').css(background_rgba);
    $jqInitColors('.h-cat-1 .flex-control-paging li a.flex-active').css(background_rgba);
    $jqInitColors('.h-cat-1 .last-post .img-container .img-meta .post-date').css(background_rgba);
    $jqInitColors('.h-cat-1 .flexslider .flex-direction-nav > li').css(background_rgb);
    $jqInitColors('.h-cat-1 .flex-control-paging li a').css(border_rgb);
    ...
    $jqInitColors('#divRev_Cat .color-picker > .select-color-image').css(background_rgb);
    $jqInitColors('.review-cat-1 .cat-review .review .img-container .img-meta .post-result .percent').css(background_rgba);
    $jqInitColors('.review-cat-1 .flex-control-paging li a.flex-active').css(background_rgba);
    $jqInitColors('.review-cat-1 .flexslider .flex-direction-nav > li').css(background_rgb);
    $jqInitColors('.review-cat-1 .flex-control-paging li a').css(border_rgb);
    ...
    $jqInitColors('#divV_Cat .color-picker > .select-color-image').css(background_rgb);

    $jqInitColors('.v-cat-1 .modern-items-list .fold-item .description').css(background_rgba);
    $jqInitColors('.v-cat-1 .flex-control-paging li a.flex-active').css(background_rgba);
    $jqInitColors('.v-cat-1 .last-post .img-container .img-meta .post-date').css(background_rgba);
    $jqInitColors('.v-cat-1 .flexslider .flex-direction-nav > li').css(background_rgb);
    $jqInitColors('.v-cat-1 .flex-control-paging li a').css(border_rgb);
    ...
    $jqInitColors('#divV_Cat_2 .color-picker > .select-color-image').css(background_rgb);

    // Category Colors
    $jqInitColors('.v-cat-2 .modern-items-list .fold-item .description').css(background_rgba);
    $jqInitColors('.v-cat-2 .flex-control-paging li a.flex-active').css(background_rgba);
    $jqInitColors('.v-cat-2 .last-post .img-container .img-meta .post-date').css(background_rgba);
    $jqInitColors('.v-cat-2 .flexslider .flex-direction-nav > li').css(background_rgb);
    $jqInitColors('.v-cat-2 .flex-control-paging li a').css(border_rgb);
...
$jqStyleSwitcher(document).ready(function () {
    ...
    $jqStyleSwitcher('#divColorRed > a').ColorPicker({
        ...
        onChange: function (hsb, hex, rgb) {
            ...
            //$jqStyleSwitcher('#cssThemeColor[rel=stylesheet]').attr('href', '../ctr-news-ltr/skin-and-color/color/skin-red-d02222.css');
            ...
            // Background Colors
            $jqStyleSwitcher('.navbar-main .navbar .nav li.dropdown.open > .dropdown-toggle, .navbar-main .navbar .nav li.dropdown.active > .dropdown-toggle, .navbar-main .navbar .nav li.dropdown.open.active > .dropdown-toggle, .navbar-main .navbar .nav > .active > a, .btn-theme, .breaking-news-widget > .row-fluid > .title, .widget .widget-content ul.tabs-header > li.btn-theme.active > a, .article-content .social-share-footer .figure, .carousel-nav .carousel-indicators .active, .flex-control-paging li a.flex-active, .flexslider .flex-direction-nav > li, .article-content .blog .paging-footer .pagination ul > .active a, .widget-title > h3:after, .cat-widget-title h3:after, .widget-title > h4:after, .f-widget-title > h4:after, .cat-widget .cat-widget-title h3:after').css(background_rgb);
            ...
            $jqStyleSwitcher('.flex-control-paging li a, .breaking-news-widget').css(border_rgb);
    ...
    $jqStyleSwitcher('#divColorBlue a').click(function () {
        $jqStyleSwitcher('#cssThemeColor[rel=stylesheet]').attr('href', '../ctr-news-ltr/skin-and-color/color/skin-B-29B6D1.css');
    });
    $jqStyleSwitcher('#divColorOrange a').click(function () {
        $jqStyleSwitcher('#cssThemeColor[rel=stylesheet]').attr('href', '../ctr-news-ltr/skin-and-color/color/skin-Ora-FF1F00.css');
    });
    $jqStyleSwitcher('#divColorGreen a').click(function () {
        $jqStyleSwitcher('#cssThemeColor[rel=stylesheet]').attr('href', '../ctr-news-ltr/skin-and-color/color/skin-G-4AB403.css');
    });
    $jqStyleSwitcher('#divColorBlue2 a').click(function () {
        $jqStyleSwitcher('#cssThemeColor[rel=stylesheet]').attr('href', '../ctr-news-ltr/skin-and-color/color/skin-B2-0E72F1.css');
    });
    $jqStyleSwitcher('#divColorMoov a').click(function () {
        $jqStyleSwitcher('#cssThemeColor[rel=stylesheet]').attr('href', '../ctr-news-ltr/skin-and-color/color/skin-Moov-8E5AEC.css');
    });
    $jqStyleSwitcher('#divColorFucia a').click(function () {
        $jqStyleSwitcher('#cssThemeColor[rel=stylesheet]').attr('href', '../ctr-news-ltr/skin-and-color/color/skin-Fucia-F730FF.css');
    });
    $jqStyleSwitcher('#divColorFucia2 a').click(function () {
        $jqStyleSwitcher('#cssThemeColor[rel=stylesheet]').attr('href', '../ctr-news-ltr/skin-and-color/color/skin-Fucia2-FF0F5B.css');
    });
    ...
    $jqStyleSwitcher('#divP-1 a').click(function () {
        $jqStyleSwitcher('html').css('background-image', 'url' + '(../images/bg/bg2.png)');
    });

    $jqStyleSwitcher('#divP-2 a').click(function () {
        $jqStyleSwitcher('html').css('background-image', 'url' + '(../images/bg/bg21.png)');
    });

    $jqStyleSwitcher('#divP-3 a').click(function () {
        $jqStyleSwitcher('html').css('background-image', 'url' + '(../images/bg/bg3.png)');
    });

    $jqStyleSwitcher('#divP-4 a').click(function () {
        $jqStyleSwitcher('html').css('background-image', 'url' + '(../images/bg/bg5.png)');
    });

    $jqStyleSwitcher('#divP-5 a').click(function () {
        $jqStyleSwitcher('html').css('background-image', 'url' + '(../images/bg/bg26.png)');
    });

    $jqStyleSwitcher('#divP-6 a').click(function () {
        $jqStyleSwitcher('html').css('background-image', 'url' + '(../images/bg/bg35.png)');
    });

    $jqStyleSwitcher('#divP-7 a').click(function () {
        $jqStyleSwitcher('html').css('background-image', 'url' + '(../images/bg/bg37.png)');
    });

    $jqStyleSwitcher('#divP-8 a').click(function () {
        $jqStyleSwitcher('html').css('background-image', 'url' + '(../images/bg/bg38.png)');
    });
    ...
    $jqStyleSwitcher('#divH_Cat a').ColorPicker({
        ...
        onChange: function (hsb, hex, rgb) {
            ...
            $jqStyleSwitcher('#divH_Cat .select-color-image').css('background-color', '#' + hex, '!important');
            $jqStyleSwitcher('.h-cat-1 .modern-items-list .fold-item .description').css(background_rgba);
            $jqStyleSwitcher('.h-cat-1 .flex-control-paging li a.flex-active').css(background_rgba);
            $jqStyleSwitcher('.h-cat-1 .cat-horiz .last-post .img-container .img-meta .post-date').css(background_rgba);
            $jqStyleSwitcher('.h-cat-1 .flexslider .flex-direction-nav > li').css(background_rgb);
            $jqStyleSwitcher('.h-cat-1 .flex-control-paging li a').css(border_rgb);
    ...
    $jqStyleSwitcher('#divRev_Cat a').ColorPicker({
        ...
        onChange: function (hsb, hex, rgb) {
            ...
            $jqStyleSwitcher('#divRev_Cat .select-color-image').css('background-color', '#' + hex, '!important');
            $jqStyleSwitcher('.review-cat-1 .cat-review .review .img-container .img-meta .post-result .percent').css(backgroundColor_rgba);
            $jqStyleSwitcher('.review-cat-1 .flex-control-paging li a.flex-active').css(background_rgba);
            $jqStyleSwitcher('.review-cat-1 .flexslider .flex-direction-nav > li').css(background_rgb);
            $jqStyleSwitcher('.review-cat-1 .flex-control-paging li a').css(border_rgb);
    ...
    $jqStyleSwitcher('#divV_Cat a').ColorPicker({
        ...
        onChange: function (hsb, hex, rgb) {
            ...
            $jqStyleSwitcher('#divV_Cat .select-color-image').css('background-color', '#' + hex, '!important');

            // Category Colors
            $jqStyleSwitcher('.v-cat-1 .modern-items-list .fold-item .description').css(background_rgba);
            $jqStyleSwitcher('.v-cat-1 .flex-control-paging li a.flex-active').css(background_rgba);
            $jqStyleSwitcher('.v-cat-1 .last-post .img-container .img-meta .post-date').css(background_rgba);
            $jqStyleSwitcher('.v-cat-1 .flexslider .flex-direction-nav > li').css(background_rgb);
            $jqStyleSwitcher('.v-cat-1 .flex-control-paging li a').css(border_rgb);
    ...
    $jqStyleSwitcher('#divV_Cat_2 a').ColorPicker({
        ...
        onChange: function (hsb, hex, rgb) {
            ...
            // Style Switcher Color
            $jqStyleSwitcher('#divV_Cat_2 .select-color-image').css('background-color', '#' + hex, '!important');

            // Category Colors
            $jqStyleSwitcher('.v-cat-2 .modern-items-list .fold-item .description').css(background_rgba);
            $jqStyleSwitcher('.v-cat-2 .flex-control-paging li a.flex-active').css(background_rgba);
            $jqStyleSwitcher('.v-cat-2 .last-post .img-container .img-meta .post-date').css(background_rgba);
            $jqStyleSwitcher('.v-cat-2 .flexslider .flex-direction-nav > li').css(background_rgb);
            $jqStyleSwitcher('.v-cat-2 .flex-control-paging li a').css(border_rgb);
