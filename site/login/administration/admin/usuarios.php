...
<form name="form1" method="post" action="">
	<a href="c_usuario.php" class="btn btn-info"><i class="icon-user"></i> Nuevo Usuario</a>
...
<table class="table table-hover" border="0">
  ...
  <tr>
    ...
    <td><a href="usuarios.php?estado=<?php echo $dato['id']; ?>"><?php echo $estado; ?></a></td>
    <td><?php echo $dato['usu']; ?></td>
    <td><?php echo $tipo; ?></td>
    <td><a href="c_usuario.php?id=<?php echo $dato['id']; ?>" title="Editar Usuario" class="btn btn-info"><i class="icon-pencil"></i></a></td>
  </tr>
  <?php } ?>
  </tbody>
</table>
