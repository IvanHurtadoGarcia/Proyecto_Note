<?php
		...
		if(!empty($_POST['empresa']) and !empty($_POST['nit'])){
			...
			$region=$_POST['region'];			$eslogan=$_POST['eslogan'];
         ...
         <form action="" method="post" enctype="multipart/form-data" name="form1">
              ...
              <tr>
                <td width="39%">
                    ...
                    <label for="">Eslogan: </label> <input type="text" name="eslogan" id="eslogan" value="<?php echo $eslogan; ?>">
                </td>
                <td width="32%" rowspan="2">
                	<label for="textfield">NIT: </label><input type="text" name="nit" id="nit" value="<?php echo $nit; ?>" required>
					...
					?>
                    <option value="<?php echo $dato['id']; ?>" <?php if($dato['id']==$region){ echo 'selected'; } ?> >
