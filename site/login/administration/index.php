...
<BODY BGCOLOR="#00000" BACKGROUND="admin/img/bg11.png" BGPROPERTIES=FIXED>
<div align="center">
<table width="77%" border="0">
  <tr>
    <td width="48%">
        <img src="admin/img/bakS.png" alt="" height="300" width="300"> 
    </td>
  ...
  <table width="100%" border="0">
      <tr>
        <td>
          	<br><br>
        	<div align="center">
                © Company 2015 <?php echo $empresa; ?><br>
