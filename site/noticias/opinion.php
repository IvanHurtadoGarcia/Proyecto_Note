...
<head>
    <title>NoteInsideNetwork | Noticias</title>
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
                            ...
                            <header>
                                <div itemscope itemtype="http://schema.org/WebPage">
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                       ...
                                       <li><a href="../noticias/nacional.php?codigo=9">Nacional</a></li>
                               ...
                               <img src="../login/administration/admin/secciones/nacional/<?php echo $noticia.'.jpg'; ?>" width="550" height="550">
                 ...
                 <aside class="widget w-pictures">
                    ...
                    <div class="widget-content clearfix thumbnails">
                         <ul class="posts-in-images clearfix">
                            <?php 
    $sqlx=mysql_query("SELECT *, DATE_FORMAT(`fecha`,'%d/%m/%Y %H:%i:%s') AS my_date FROM opinion WHERE tipo='11'  ORDER BY my_date asc LIMIT 9");
    while($datox=mysql_fetch_array($sqlx)){
            ...
            ?>
                            <li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="" title="<?php echo $datox['titulo']; ?>">
                                <a href="internacional.php?noticia=<?php echo $datox['id']; ?>">
                                    <div class="thumb-effect">
                                        <div class="mask"></div>
    ...
    while($datox=mysql_fetch_array($sqlx)){
            ...
            ?>
                            <li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="" title="<?php echo $datox['titulo']; ?>">
                                <a href="opinion.php?noticia=<?php echo $datox['id']; ?>">
                                    <div class="thumb-effect">
                                        <div class="mask"></div>
                                        <img src="../login/administration/admin/secciones/opinion/<?php echo $datox['id'].'.jpg'; ?>" height="75" width="80">
