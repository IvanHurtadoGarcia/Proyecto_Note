                ...
                <article class="article-container" itemscope itemtype="http://schema.org/Article">
                    <div class="row-fluid">
                        ...
                        <div class="article-content">
                            ...
                            <div class="blog">
                                <?php 
    $sqlx=mysql_query("SELECT *, DATE_FORMAT(`fecha`,'%d/%m/%Y %H:%i:%s') AS my_date FROM lecturas WHERE tipo='$codigo'  ORDER BY my_date desc LIMIT 5");
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                ...
                                                <img src="../login/administration/admin/secciones/lecturas/<?php echo $datox['id'].'.jpg'; ?>" height="345" width="604">
                                                <a href="nota-lec.php?noticia=<?php echo $datox['id']; ?>" class="more"></a>
                                            </div>
                                            ...
                                            <div class="media-body span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span10 blog-desc-container">
                                                            <a href="nota-lec.php?noticia=<?php echo $datox['id']; ?>" title="">
