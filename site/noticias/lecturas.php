...
<head>
    <title>NoteInsideNetwork-lecturas</title>
    ...
    <div class="container-fluid" itemscope itemtype="http://schema.org/CreativeWork">
        ...
        <div class="row-fluid">
                            ...
                            <div class="blog">
                                <ul class="media-list">
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[1].'.jpg'; ?>" height="345" width="604">
                                   ...
                                   <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[2].'.jpg'; ?>" height="345" width="604">
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[3].'.jpg'; ?>"height="345" width="604">
                                            ...
                                            <ul class="items left clearfix">
                                                ...
                                                <li>
                                                    <article class="fold-item span12">
                                                        <div class="clearfix">
                                                           <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[4].'.jpg'; ?>" height="301" width="240">
                                        ...
                                        <li>
                                            <ul class="items left clearfix">
                                                ...
                                                <li>
                                                    <article class="fold-item span12">
                                                        <div class="clearfix">
                                                            <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[5].'.jpg'; ?>"height="301" width="240px">
                                        ...
                                        <li>
                                            <ul class="items left clearfix">
                                                ...
                                                <li>
                                                    <article class="fold-item span12">
                                                        <div class="clearfix">
                                                            <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[6].'.jpg'; ?>"height="301" width="240px">
                                        ...
                                        <li>
                                            <ul class="items left clearfix">
                                                ...
                                                <li>
                                                    <article class="fold-item span12">
                                                        <div class="clearfix">
                                                            <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[7].'.jpg'; ?>"height="301" width="240px">
                                        ...
                                        <li>
                                            <ul class="items left clearfix">
                                                ...
                                                <li>
                                                    <article class="fold-item span12">
                                                        <div class="clearfix">
                                                            <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[8].'.jpg'; ?>"height="301" width="240px">
                                        ...
                                        <li>
                                            <ul class="items left clearfix">
                                                ...
                                                <li>
                                                    <article class="fold-item span12">
                                                        <div class="clearfix">
                                                            <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[9].'.jpg'; ?>"height="301" width="240px">
                                        ...
                                        <li>
                                            <ul class="items left clearfix">
                                                ...
                                                <li>
                                                    <article class="fold-item span12">
                                                        <div class="clearfix">
                                                            <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[10].'.jpg'; ?>"height="301" width="240px">
                                        ...
                                        <li>
                                            <ul class="items left clearfix">
                                                ...
                                                <li>
                                                    <article class="fold-item span12">
                                                        <div class="clearfix">
                                                            <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[11].'.jpg'; ?>"height="301" width="240px">
            ...
            <section class="span300">
                ...
                <!-- lecturas Posts (Classic) -->
                <aside class="widget w-posts">
                    <div class="widget-title">
                        <h4>Posts lecturas (clasicos) </h4>
                    </div>
                                    ...
                                    <article>
                                        <a href="../post-formats/post-image-lightbox.html" class="span3" title="">
                                            <div class="media-object thumb-effect">
                                                <div class="mask"></div>
                                                <img  <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[12].'.jpg'; ?>"height="65" width="65">
                                            </div>
                                        </a>
                                ...
                                <li class="media">
                                    <article>
                                        <a href="../post-formats/post-image-lightbox.html" class="span3" title="">
                                            <div class="media-object thumb-effect">
                                                <div class="mask"></div>
                                                <img  <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[13].'.jpg'; ?>"height="65" width="65">
                                            </div>
                                        </a>
                                ...
                                <li class="media">
                                    <article>
                                        <a href="../post-formats/post-image-lightbox.html" class="span3" title="">
                                            <div class="media-object thumb-effect">
                                                <div class="mask"></div>
                                                <img  <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[14].'.jpg'; ?>"height="65" width="65">
                                            </div>
                                        </a>
                                ...
                                <li class="media">
                                    <article>
                                        <a href="../post-formats/post-image-lightbox.html" class="span3" title="">
                                            <div class="media-object thumb-effect">
                                                <div class="mask"></div>
                                                <img  <img src="../login/administration/admin/secciones/lecturas/<?php echo $v_foto[15].'.jpg'; ?>"height="65" width="65">
                                            </div>
                                        </a>
