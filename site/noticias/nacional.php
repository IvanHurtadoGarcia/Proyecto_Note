                            ...
                            <header>
                                <div itemscope itemtype="http://schema.org/WebPage">
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><li><a href="../noticias/nacional.php?codigo=9">Internacional</a></li>
                                    </ul>
                                </div>

                                <h1 itemprop="headline">Recientes</h1>
...
<?php 
    $sqlx=mysql_query("SELECT *, DATE_FORMAT(`fecha`,'%d/%m/%Y %H:%i:%s') AS my_date FROM nacional WHERE tipo='10'  ORDER BY my_date desc LIMIT 5");
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                ...
                                                <img src="../login/administration/admin/secciones/nacional/<?php echo $datox['id'].'.jpg'; ?>" height="345" width="604">
                                                <a href="../nota/nacio.php?noticia=<?php echo $datox['id']; ?>" class="more"></a>
                                            </div>
                                            ...
                                            <div class="media-body span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span10 blog-desc-container">
                                                            <a href="../nota/nacio.php?noticia=<?php echo $datox['id']; ?>" title="">
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <a href="../nota/nacio.php?noticia=<?php echo $datox['id']; ?>" class="btn-theme">Continuuar Leyendo...</a>
                                                        </div>
                                                    </div>
                                                </div>
