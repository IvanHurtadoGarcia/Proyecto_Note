...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
                 ...
                 <aside class="widget w-pictures">
                    ...
                    <div class="widget-content clearfix thumbnails">
                         <ul class="posts-in-images clearfix">
                            <?php 
    $sqlx=mysql_query("SELECT *, DATE_FORMAT(`fecha`,'%d/%m/%Y %H:%i:%s') AS my_date FROM nacional WHERE tipo='10'  ORDER BY my_date asc LIMIT 9");
    ...
    while($datox=mysql_fetch_array($sqlx)){
            ...
            ?>
                            <li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="" title="<?php echo $datox['titulo']; ?>">
                                <a href="nacional.php?noticia=<?php echo $datox['id']; ?>">
                                    <div class="thumb-effect">
                                        <div class="mask"></div>
                                        <img src="../login/administration/admin/secciones/nacional/<?php echo $datox['id'].'.jpg'; ?>" height="75" width="80">
