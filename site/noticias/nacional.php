...
<?php 
    $sqlx=mysql_query("SELECT *, DATE_FORMAT(`fecha`,'%d/%m/%Y %H:%i:%s') AS my_date FROM nacionl WHERE tipo='$codigo'  ORDER BY my_date desc LIMIT 5");
    while($datox=mysql_fetch_array($sqlx)){
            ...
            ?>
                              <ul class="media-list">
                                            ...
                                            <div class="media-body span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span10 blog-desc-container">
                                                            <a href="nacio.php?noticia=<?php echo $datox['id']; ?>" title="">
                                   ...
                                   <?php } 
    $sqlx=mysql_query("SELECT *, DATE_FORMAT(`fecha`,'%d/%m/%Y %H:%i:%s') AS my_date FROM nacional WHERE tipo='$codigo'  ORDER BY my_date desc LIMIT 5");
