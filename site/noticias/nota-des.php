<?php 
   include('../php_conexion.php');
    if(!empty($_GET['noticia'])){
        ...
        $sqlx=mysql_query("SELECT * FROM descargas WHERE id=$noticia");
                            ...
                            <header>
                                <div itemscope itemtype="http://schema.org/WebPage">
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="descargas.php?codigo=13" class="active">descargas</a></li>
                                    </ul>
                                </div>
                               ...
                               <img src="../login/administration/admin/secciones/descargas/<?php echo $noticia.'.jpg'; ?>" width="550" height="550">
