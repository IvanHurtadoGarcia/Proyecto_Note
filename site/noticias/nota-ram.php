<?php 
   include('../php_conexion.php');
    if(!empty($_GET['noticia'])){
        ...
        $sqlx=mysql_query("SELECT * FROM random WHERE id=$noticia");
    ...
    $x=0;
    $sqlx=mysql_query("SELECT *, DATE_FORMAT(`fecha`,'%d/%m/%Y %H:%i:%s') AS my_date FROM random  ORDER BY my_date desc ");
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="article-content">
                            <header>
                               ...
                               <img src="../login/administration/admin/secciones/random/<?php echo $noticia.'.jpg'; ?>" width="550" height="550">
                                ...
                                <div class="post-info">
                                    <div class="post-meta">
                                        <ul>
                                           <!-- <li title="Post Author"><a href="#"><i class="bo-icon-pencil"></i><?php echo $v_usu['6'] ?></a></li>-->
                 ...
                 <aside class="widget w-pictures">
                    ...
                    <div class="widget-content clearfix thumbnails">
                         <ul class="posts-in-images clearfix">
                            <?php 
    $sqlx=mysql_query("SELECT *, DATE_FORMAT(`fecha`,'%d/%m/%Y %H:%i:%s') AS my_date FROM random WHERE tipo='13'  ORDER BY my_date asc LIMIT 9");
    while($datox=mysql_fetch_array($sqlx)){
            ...
            ?>
                            <li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="" title="<?php echo $datox['titulo']; ?>">
                                <a href="nota-des.php?noticia=<?php echo $datox['id']; ?>">
                                    <div class="thumb-effect">
                                        <div class="mask"></div>
                                        <img src="../login/administration/admin/secciones/random/<?php echo $datox['id'].'.jpg'; ?>" height="75" width="80">
