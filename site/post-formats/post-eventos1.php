                            ...
                            <header>
                                <div itemscope itemtype="http://schema.org/WebPage">
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="post-eventosdatos1.php" class="active">Noticias de Tecnol&oacute;gia</a></li>
                                    </ul>
                                </div>
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                ...
                                                <a href="post-eventosdatos1.php?noticia=<?php echo $datox['id']; ?>" class="more"></a>
                                            </div>
                                                ...
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span10 blog-desc-container">
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <a href="post-eventosdatos1.php?eventos=<?php echo $datox['id']; ?>" class="btn-theme">Continuuar Leyendo...</a>
                                                        </div>
                                                    </div>
                                                </div>
