<?php 
    ...
    $n=0;
    $sqll=mysql_query("SELECT * FROM eventos");
                            ...
                            <header>
                                <div itemscope itemtype="http://schema.org/WebPage">
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="post-image-eventosdatos.php" class="active">Eventos</a></li>
                                    </ul>
                                </div>

                                <h1 itemprop="headline">Noticias sobre Eventos</h1>
                            ...
                            <div class="blog">
                                <ul class="media-list">
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/evento/<?php echo $v2_foto[1].'.jpg'; ?>" height="345" width="604">
                                            ...
                                            <div class="media-body span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span10 blog-desc-container">
                                                            <a href="juegos.php?titulo=<?php echo $v2_titulo['1'] ?>&id=3" title="">
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <a href="juegos.php?titulo=<?php echo $v2_titulo['1'] ?>&id=3" class="btn-theme">Continuuar Leyendo...</a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/vevento/<?php echo $v2_foto[2].'.jpg'; ?>" height="345" width="604">
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/evento/<?php echo $v2_foto[3].'.jpg'; ?>" height="345" width="604">
                                            ...
                                            <div class="media-body span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span10 blog-desc-container">
                                                            <a href="juegos.php?titulo=<?php echo $v2_titulo['3'] ?>&id=1" title="">
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/evento/<?php echo $v2_foto[4].'.jpg'; ?>" height="345" width="604">
                                            ...
                                            <div class="media-body span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span10 blog-desc-container">
                                                            <a href="juegos.php?titulo=<?php echo $v2_titulo['4'] ?>&id=4" title="">
