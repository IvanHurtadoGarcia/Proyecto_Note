<?php 
   include('../php_conexion.php');
    if(!empty($_GET['eventos'])){
        $noticia=$_GET['eventos'];
        $sqlx=mysql_query("SELECT * FROM noticias WHERE id=$eventos");
    ...
    $x=0;
    $sqlx=mysql_query("SELECT *, DATE_FORMAT(`fecha`,'%d/%m/%Y %H:%i:%s') AS my_date FROM eventos  ORDER BY my_date desc ");
                            ...
                            <header>
                                <div itemscope itemtype="http://schema.org/WebPage">
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="post-evento1.php" class="active">Tecol&oacute;gias</a></li>
                                    </ul>
                                </div>
                               ...
                               <img src="../login/administration/admin/secciones/eventos/<?php echo $eventos.'.jpg'; ?>" width="550" height="550">
                 ...
                 <aside class="widget w-pictures">
                    ...
                    <div class="widget-content clearfix thumbnails">
                        <ul class="posts-in-images clearfix">
                            <li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="" title="<?php echo $v_titulo['1'] ?>">
                                <a href="post-formats/post-image.html">
                                    <div class="thumb-effect">
                                        <div class="mask"></div>
                                        <img src="../login/administration/admin/secciones/nacional/<?php echo $v_foto[1].'.jpg'; ?>" height="75" width="80">
                                        
                                    </div>
                                </a>
                            </li>

                            <li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="" title="<?php echo $v_titulo['2'] ?>">
                                <a href="post-formats/post-video.html">
                                    <div class="thumb-effect">
                                        <div class="mask"></div>
                                       <img src="../login/administration/admin/secciones/nacional/<?php echo $v_foto[2].'.jpg'; ?>" height="75" width="80">
                                    </div>
                                </a>
                            </li>

                            <li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="" title="<?php echo $v_titulo['3'] ?>">
                                                ...
                                                <li>
                                                    <article class="fold-item span12">
                                                        <div class="clearfix">
                                                            ...
                                                            <img src="../login/administration/admin/secciones/eventos/<?php echo $v_foto[1].'.jpg'; ?>" height="200" width="271">
                                                            ...
                                                            <a href="post-eventosdatos1.php?titulo=<?php echo $v_titulo['1'] ?>&id=6" class="more" title=""></a>
                                                        </div>
                                                    </article>
                                                </li>
                                                ...
                                                <li>
                                                    <article class="fold-item span12">
                                                        <div class="clearfix">
                                                            ...
                                                            <img src="../login/administration/admin/secciones/eventos/<?php echo $v_foto[2].'.jpg'; ?>" height="200" width="271">
                                                            <div class="post-sitemap">
                                                                <span><i class="bo-icon-home bo-icon-white"></i>Tecnol&oacute;gias</span>                                                            </div>
                                                            ...
                                                            <a href="post-eventosdatos1.php?titulo=<?php echo $v_titulo['2'] ?>&id=5" class="more" title=""></a>
                                                        </div>
                                                    </article>
                                                </li>
                                            </ul>
                                                ...
                                                <li>
                                                   <article class="fold-item span12">
                                                        <div class="clearfix">
                                                            ...
                                                            <img src="../login/administration/admin/secciones/evento/<?php echo $v_foto[3].'.jpg'; ?>" height="200" width="271">
                                                            <div class="post-sitemap">
                                                                <span><i class="bo-icon-home bo-icon-white"></i>Tecnol&oacute;gias</span>                                                            </div>
                                                            ...
                                                            <a href="post-eventosdatos1.php?titulo=<?php echo $v_titulo['3'] ?>&id=4" class="more" title=""></a>
                                                        </div>
                                                    </article>
                                                </li>
                                                ...
                                                <li>
                                                    <article class="fold-item span12">
                                                        <div class="clearfix">
                                                            ...
                                                            <img src="../login/administration/admin/secciones/eventos/<?php echo $v_foto[4].'.jpg'; ?>" height="200" width="271">
                                                            <div class="post-sitemap">
                                                            ...
                                                            <a href="post-eventosdatos1.php?titulo=<?php echo $v_titulo['4'] ?>&id=3" class="more" title=""></a>
                                                        </div>
                                                    </article>
                                                </li>
                                            </ul>
