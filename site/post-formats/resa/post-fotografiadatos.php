<?php 
    ...
    $x2=0;
    $sqlx2=mysql_query("SELECT *, DATE_FORMAT(`fecha`,'%d/%m/%Y %H:%i:%s') AS my_date FROM fotografia ORDER BY my_date desc ");
                            ...
                            <div class="blog">
                                <ul class="media-list">
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/fotografia/<?php echo $v2_foto[1].'.jpg'; ?>" height="345" width="604">

                                                <a href="post-fotografia.php?titulo=<?php echo $v2_titulo['1'] ?>&id=4" class="more"></a>
                                            </div>
                                            ...
                                            <div class="media-body span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span10 blog-desc-container">
                                                            <a href="post-fotografia.php?titulo=<?php echo $v2_titulo['4'] ?>&id=4" title="">
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <a href="post-fotografia.php?titulo=<?php echo $v2_titulo['1'] ?>&id=3" class="btn-theme">Continuuar Leyendo...</a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/fotografia/<?php echo $v2_foto[3].'.jpg'; ?>" height="345" width="604">

                                                <a href="post-fotografia.php?titulo=<?php echo $v2_titulo['3'] ?>&id=2" class="more"></a>
                                            </div>
                                            ...
                                            <div class="media-body span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span10 blog-desc-container">
                                                            <a href="post-fotografia.php?titulo=<?php echo $v2_titulo['2'] ?>&id=2" title="">
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <a href="post-fotografia.php?titulo=<?php echo $v2_titulo['3'] ?>&id=3" class="btn-theme">Continuuar Leyendo...</a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/fotografia/<?php echo $v2_foto[2].'.jpg'; ?>" height="345" width="604">

                                                <a href="post-fotografia.php?titulo=<?php echo $v2_titulo['3'] ?>&id=3" class="more"></a>
                                            </div>
                                            ...
                                            <div class="media-body span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span10 blog-desc-container">
                                                            <a href="post-fotografia.php?titulo=<?php echo $v2_titulo['3'] ?>&id=3" title="">
                                                            <h4 class="media-heading"><?php echo $v2_titulo['2'] ?></h4>
                                                        </a>
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <a href="post-fotografia.php?titulo=<?php echo $v2_titulo['3'] ?>&id=4" class="btn-theme">Continuuar Leyendo...</a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/fotografia/<?php echo $v2_foto[4].'.jpg'; ?>" height="345" width="604">

                                                <a href="post-fotografia.php?titulo=<?php echo $v2_titulo['4'] ?>&id=1" class="more"></a>
                                            </div>
                                            ...
                                            <div class="media-body span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span10 blog-desc-container">
                                                            ...
                                                            <a href="post-fotografia.php?titulo=<?php echo $v2_titulo['4'] ?>&id=1" title="">
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <a href="post-fotografia.php?titulo=<?php echo $v2_titulo['1'] ?>&id=1" class="btn-theme">Continuuar Leyendo...</a>
                                                        </div>
                                                    </div>
                                                </div>
