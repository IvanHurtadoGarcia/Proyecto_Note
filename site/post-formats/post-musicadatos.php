<?php 
    ...
    $x2=0;
    $sqlx2=mysql_query("SELECT *, DATE_FORMAT(`fecha`,'%d/%m/%Y %H:%i:%s') AS my_date FROM recomendacionm ORDER BY my_date desc ");
                            ...
                            <header>
                                <div itemscope itemtype="http://schema.org/WebPage">
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="musica.php" class="active">Musica</a></li>
                                    </ul>
                                </div>

                                <h1 itemprop="headline">Recoendacion musical</h1>
                            ...
                            <div class="blog">
                                <ul class="media-list">
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/musica/<?php echo $v2_foto[1].'.jpg'; ?>" height="345" width="604">
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/musica/<?php echo $v2_foto[2].'.jpg'; ?>" height="345" width="604">
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/musica/<?php echo $v2_foto[3].'.jpg'; ?>" height="345" width="604">
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/musica/<?php echo $v2_foto[4].'.jpg'; ?>" height="345" width="604">
