                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                ...
                                                <a href="post-eventos.php?noticia=<?php echo $datox['id']; ?>" class="more"></a>
                                            </div>
                                            ...
                                            <div class="media-body span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span10 blog-desc-container">
                                                            <a href="post-eventos.php?noticia=<?php echo $datox['id']; ?>" title="">
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <a href="post-eventos.php?noticia=<?php echo $datox['id']; ?>" class="btn-theme">Continuuar Leyendo...</a>
                                                        </div>
                                                    </div>
                                                </div>
