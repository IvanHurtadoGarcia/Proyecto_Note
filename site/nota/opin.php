                            ...
                            <header>
                                <div itemscope itemtype="http://schema.org/WebPage">
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><li><a href="../noticias/opinion.php?codigo=9">Opinion</a></li>
                                    </ul>
                                </div>
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                ...
                                                <img src="../login/administration/admin/secciones/opinion/<?php echo $datox['id'].'.jpg'; ?>" height="345" width="604">
                                                <a href="opinion.php?noticia=<?php echo $datox['id']; ?>" class="more"></a>
                                            </div>
                                            ...
                                            <div class="media-body span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span10 blog-desc-container">
                                                            <a href="opinion.php?noticia=<?php echo $datox['id']; ?>" title="">
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <a href="opinion.php?noticia=<?php echo $datox['id']; ?>" class="btn-theme">Continuuar Leyendo...</a>
                                                        </div>
                                                    </div>
                                                </div>
