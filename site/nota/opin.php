<?php 
   include('../php_conexion.php');
    if(!empty($_GET['noticia'])){
        ...
        $sqlx=mysql_query("SELECT * FROM opinion WHERE id=$noticia");
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="article-content">
                            <header>
                               ...
                               <img src="../login/administration/admin/secciones/opinion/<?php echo $noticia.'.jpg'; ?>" width="550" height="550">
    ...
    while($datox=mysql_fetch_array($sqlx)){
            ...
            ?>
                            <li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="" title="<?php echo $datox['titulo']; ?>">
                                <a href="opin.php?noticia=<?php echo $datox['id']; ?>">
                                    <div class="thumb-effect">
                                        <div class="mask"></div>
