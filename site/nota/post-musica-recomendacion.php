...
<head>
    <title>NoteInsideNetwork | Recomendaciones Misicales</title>
                        ...
                        <ul class="nav">
                            ...
                            <li class="dropdown" role="menu" aria-labelledby="dLabel">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="post-image-lightbox.html">Featured Image With Lightbox</a></li>
                                    <li><a href="post-review.html">Review Criteria</a></li>
                                    <li><a href="post-video.html">Video</a></li>
                                    <li><a href="post-soundcloud.html">Sound-Cloud</a></li>

                                    <li><a href="post-googlemap.html">Google Map</a></li>
                                    <li><a href="post-self-audio.html">Self Hosted Audio</a></li>
                                    <li><a href="post-self-video.html">Self Hosted Video</a></li>
                                </ul>
                            </li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="article-content">
                            <header>
                                <div itemscope itemtype="http://schema.org/WebPage">
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        <li>
                                            <a href="#"><i class="bo-icon-home"></i>Local News</a><i class="icon-caret-right icon-fixed-width"></i></li>
                                        <li><a href="#" class="active">Post With Video</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="figure-container">
                                    <figure class="featured-post-figure" itemprop="associatedMedia" itemscope itemtype="http://schema.org/VideoObject">
                                        ...
                                        <iframe class="youtube-player" type="text/html"
                                            width="100%" height="385" src="https://www.youtube.com/embed/nVjsGKrE6E8?wmode=transparent&amp;wmode=opaque"
                                            allowfullscreen frameborder="0"></iframe>

                                        <figcaption itemprop="caption">Captura de video
                                        </figcaption>
                                    </figure>
                                </div>


                                <h1 itemprop="headline">Recomendacion Musical</h1>

                                <div class="post-info">
                                    <div class="post-meta">
                                        <ul>
                                            <li title="Post Author"><a href="#"><i class="bo-icon-pencil"></i>Serpentsoft</a></li>
                            ...
                            <div class="post-entry" itemprop="articleBody">
                                ...
                                <span class="drop-capital">D</span>escripcion del video .
                            
                                <blockquote>
                                <p>Informacion del video y artista </p>
                            </blockquote>

                                <p>OTRAS COSAS QUE SE PUEDEM MENCIANAR SOBRE LA RECOMENACION MUSICAL </p>
                          </div>
