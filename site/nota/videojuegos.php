                            ...
                            <div class="blog">
                                <ul class="media-list">
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/videojuegos/<?php echo $v2_foto[1].'.jpg'; ?>" height="345" width="604">
                                    ...
                                    <li class="media blog-item">
                                        <article>
                                            <div class="span12 img-container" title="">
                                                <img src="../login/administration/admin/secciones/videojuegos/<?php echo $v2_foto[2].'.jpg'; ?>" height="345" width="604">
