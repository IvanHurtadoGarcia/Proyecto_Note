<?php 
    ...
    if(!empty($_GET['noticia'])){
        $id=$_GET['noticia'];
        $sqlx=mysql_query("SELECT * FROM reviews WHERE id=$id");
    ...
    $x=0;
    $sqlx=mysql_query("SELECT *, DATE_FORMAT(`fecha`,'%d/%m/%Y %H:%i:%s') AS my_date FROM reviews ORDER BY my_date desc ");
                            ...
                            <header>
                                <div itemscope itemtype="http://schema.org/WebPage">
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="reviews.php?codigo=3" class="active">Reviews</a></li>
                                    </ul>
                                </div>
                               ...
                               <img src="../login/administration/admin/secciones/reviews/<?php echo $id.'.jpg'; ?>" width="550" height="550">
